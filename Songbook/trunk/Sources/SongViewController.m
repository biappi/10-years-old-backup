...
{	
	...
	[songView stringByEvaluatingJavaScriptFromString:@"i = window.pageYOffset + 1;"];
...
- (void)scrollCB;
{
	NSString * oldYOffset = [songView stringByEvaluatingJavaScriptFromString:@"window.pageYOffset"];
	[songView stringByEvaluatingJavaScriptFromString:@"window.scrollBy(0, window.pageYOffset + 1);"];	
	NSString * newYOffset = [songView stringByEvaluatingJavaScriptFromString:@"window.pageYOffset"];
	
	if ([oldYOffset isEqualToString:newYOffset])
		[self stopScrolling];
}
